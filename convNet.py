...
#    print(model.summary())
    ...
    model.add(Convolution2D(num_featmaps, kernel_size[0], kernel_size[1], border_mode='same', input_shape=(1, input_rows,input_cols)))
    model.add(Activation('relu'))
    # Layer 2:
    model.add(Convolution2D(num_featmaps,  kernel_size[0], kernel_size[1]))
    model.add(Activation('relu'))
...
#    model.add(Dense(num_classes, activation='softmax'))
    ...
    model.fit(X_train, y_train, nb_epoch = num_epochs)
